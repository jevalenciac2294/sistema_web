...
<div class="col-md-12">
          ...
          <div class="col-md-12">
            ...
            <label class="col-sm-2" for="tipo">Rol a asignar*</label>
                ...
                <div class="col-sm-4" >
                  ...
                  <button  type="button" class="btn btn-xs btn-primary" onclick="asignar_rol('{{ $users->id }}');" >Asignar rol</button>    
                </div>
          ...
          <hr>
           ...
           <div class="col-md-12">
            ...
            <label class="col-sm-2" for="tipo">Rol a quitar*</label>
                ...
                <div class="col-sm-4" >         
                  <button type="button" class="btn btn-xs btn-primary" onclick="quitar_rol({{ $users->id }});" >Quitar rol</button>    
                </div>
  ...
  <div class="box box-primary box-gris">
      ...
      <div class="box-body">
          ...
          <form   action="{{url('admin/update', [$users->id])}}"  method="post" id="f_editar_usuario"  class="formentrada"  >
          ...
          <div class="col-md-6">
              <div class="form-group">
                    ...
                    <div class="col-sm-10" >
                      <input type="text" class="form-control" id="nombres" name="nombres"  value="{{ $users->name }}"  required   >
                       </div>
              </div><!-- /.form-group -->
          </div><!-- /.col -->
  ...
  <div class="box box-primary   box-gris" style="margin-bottom: 200px;">
    ...
    <div class="box-body">
                ...
                <form   action="{{ url('editar_acceso'), [$users->id]}}"  method="post" id="f_editar_acceso"  class="formentrada"  >
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
